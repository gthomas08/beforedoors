...
export class AgentMail {
  ...
  async runtimeConfig() {
    return {
      ...
      onEvent: this.onEvent ? { fnHandle: await createFunctionHandle(this.onEvent) } : undefined,
