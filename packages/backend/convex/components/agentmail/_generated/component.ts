...
export type ComponentApi<Name extends string | undefined = string | undefined> = {
  lib: {
    cancelSend: FunctionReference<"mutation", "internal", { outboundId: string }, any, Name>;
    ...
    createInbox: FunctionReference<
      ...
      Name
    >;
    deleteInbox: FunctionReference<"action", "internal", { inboxId: string }, any, Name>;
    enqueueSend: FunctionReference<
      ...
      Name
    >;
    getCachedInbox: FunctionReference<"query", "internal", { inboxId: string }, any, Name>;
    getInboxRemote: FunctionReference<"action", "internal", { inboxId: string }, any, Name>;
    getMessage: FunctionReference<
      ...
      Name
    >;
    getOutboundStatus: FunctionReference<"query", "internal", { outboundId: string }, any, Name>;
